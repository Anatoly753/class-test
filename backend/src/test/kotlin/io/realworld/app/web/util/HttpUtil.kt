...
class HttpUtil(port: Int) {
    ...
    fun registerUser(email: String, name: String, surname: String, patronymic: String?, password: String, classNumber: Int, classId: Long?): UserDTO {      //========== ENUM ===========
//        val userDTO = UserDTO(User(email = email, name = name, surname = surname, patronymic = patronymic, password = password, classNumber = classNumber, classId = classId, role = role))
        val userDTO = UserDTO(User(email = email, name = name, surname = surname, patronymic = patronymic, password = password, classNumber = classNumber, classId = classId))
