...
<div style="max-width: 800px;">
  <TextField
    ...
    maxlength="150"
    rules={titleRules}
    class="mt-2">Название теста</TextField>
  ...
  <div style="max-width: 300px; margin: 0 auto;">
    <Select outlined items={subjectItems} bind:value={subject}>Предмет</Select>
  </div>

  <p class="text-center" style="height: 35px;">
    <b>Класс: {test.classNumber} </b>
  </p>
  <div class="slider">
    <Slider
      thumb
